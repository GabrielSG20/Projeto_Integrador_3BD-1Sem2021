...
cdl_rev_number int default 0 not null, 
cdl_rev_date date,
emp_id int, 
cdl_arquive_url varchar(500),
constraint pk_codelist primary key (mnl_id,flg_secundary,cdl_section,cdl_block, cdl_rev_number)
);
